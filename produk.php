      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-9 col-md-7">
            ...
            $data = mysqli_query($koneksi,"SELECT * from produk,brand WHERE 
                                  brand_id=produk_brand
                                  order by produk_id");
            while($d = mysqli_fetch_array($data)){
            ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product__item">
                   ...
                   >
                    ...
                    <h6><?php echo $d['brand_nama']; ?> - <a href="produk-detail.php?id=<?php echo $d['produk_id'] ?>"><?php echo $d['produk_nama']; ?></a></h6>
